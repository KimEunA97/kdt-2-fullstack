...
* * 이러한 형태를 '콜백'이라고 합니다.
* * 두개의 함수로 역할을 분리하는 점에서 작성의도에 따라 매우 편리하게
...
* * '호출함과 동시에' 작성, 파악할 수 있습니다.
* * 예제의 함수는 함수이긴하나 '이름이 없는' 익명 함수입니다.
* 
* * 함수는 exampleTwo() 라는 함수 하나이며, 콜백함수 한개를 가지고 있습니다.
* * exampleTwo() 첫번째 매개변수 message는 익명함수(콜백함수)의 매개변수로 전달됩니다.
